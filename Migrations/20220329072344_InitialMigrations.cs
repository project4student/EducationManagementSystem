    ...
    public partial class InitialMigrations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubjectAssigned", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubjectAssigned_AspNetUsers_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SubjectAssigned_Subject_SubjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubjectAssigned_SubjectId",
                table: "SubjectAssigned",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_SubjectAssigned_TeacherId",
                table: "SubjectAssigned",
                column: "TeacherId");
        }
